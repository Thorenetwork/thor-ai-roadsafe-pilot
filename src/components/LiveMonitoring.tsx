...
import { MapPin, Users, Car, AlertTriangle, Clock, ChevronLeft, ChevronRight } from "lucide-react";
...
const LiveMonitoring = () => {
  ...
  // Auto-advance pages every 4 minutes
  useEffect(() => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Page 0: Live Monitoring Overview */}
      {currentPage === 0 && (
        <>
